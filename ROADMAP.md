...
Historical and planned repo tasks for Fortudo.
...
- [ ] (vNext) make Fortudo a PWA: installable and offline-friendly as a first-class web app
  - consider an in-app install call-to-action so PWA installation is discoverable, including Chrome's install prompt and Safari's Share → Add to Home Screen guidance
